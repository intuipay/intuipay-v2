/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: 2522218f0b2ab571dd87e3073f980a00)
// Runtime types generated with workerd@1.20250813.0 2025-08-14 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		...
		TIDB_CLOUD_ENDPOINT: string;
		NEXT_PUBLIC_USDC_CONTRACT_ADDRESS: string;
		NEXT_PUBLIC_WALLETCONNECT_PROJECT_ID: string;
		API_LAYER_ACCESS_KEY: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXTJS_ENV" | "RESEND_KEY" | "TIDB_CLOUD_API_KEY" | "TIDB_CLOUD_ENDPOINT" | "NEXT_PUBLIC_USDC_CONTRACT_ADDRESS" | "NEXT_PUBLIC_WALLETCONNECT_PROJECT_ID" | "API_LAYER_ACCESS_KEY" | "NEXT_PUBLIC_DASHBOARD_URL" | "BETTER_AUTH_SECRET">> {}
}
